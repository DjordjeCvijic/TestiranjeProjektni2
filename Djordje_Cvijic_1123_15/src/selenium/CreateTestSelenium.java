...
public class CreateTestSelenium	 {
...
public void createTest() {
	    ...
	    vars.put("c", driver.findElements(By.xpath("//*[@id=\"DataTables_Table_0\"]/tbody/tr")).size());
	    System.out.println(vars.get("c").toString());
	    assertEquals( vars.get("c").toString(),"1");
	    
	    assertThat(driver.findElement(By.xpath("/html/body/app-root/div/app-student-list/div[1]/div[2]/div/table/tbody/tr/td[1]")).getText(), is("marko"));
	    assertThat(driver.findElement(By.xpath("/html/body/app-root/div/app-student-list/div[1]/div[2]/div/table/tbody/tr/td[2]")).getText(), is("markovic@email"));
