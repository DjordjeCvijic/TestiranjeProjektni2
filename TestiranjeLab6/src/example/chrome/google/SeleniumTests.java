...
public class SeleniumTests {
  ...
  public void createTest() {
	    ...
	    vars.put("c", driver.findElements(By.xpath("//*[@id=\"DataTables_Table_1\"]/tbody/tr")).size());
//	    int i=driver.findElements(By.xpath("//*[@id=\"DataTables_Table_1\"]/tbody/tr")).size();
//	    System.out.println("adasdaaaaaaa: "+i);
//	    System.out.println(vars.get("c").toString());
	    assertEquals( "1",vars.get("c").toString());
	  }
}
